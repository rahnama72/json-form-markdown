...
def json_book_chapters_form_markdown(book_object):
    ...
    ****************************************
    ...
    final_book_chapters_dict.update({"title": book_object.title})
    final_book_chapters_dict.update({"h1s": final_h1_list})

    # If you want to save book-chapter.json, uncomment these three following lines:
    # import json
    # with open('book-chapter.json', 'w', encoding="utf-8") as json_file:
    #     json.dump(json_final_book_chapters, json_file,ensure_ascii=False)

    # If you want to return json file, uncomment these three following lines:
    # import json
    # final_book_chapters_json = json.dumps(final_book_chapters_dict, ensure_ascii=False)
    # return final_book_chapters_json

    # If you want to return python dict, uncomment this following line:
    return final_book_chapters_dict
